...
function Navbar() {
    return (
        <div className='w-full flex justify-center lg:justify-between p-8'>
            <div>
                <img src={logo} alt="" />
            </div>
            <div className='hidden lg:flex justify-center items-center w-fit gap-10'>
            ...
            <div className='hidden lg:flex justify-center items-center w-fit gap-4'>
